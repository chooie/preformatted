  ...
  })(
    {
      ...
      2: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function Assertable() {
              ...
              "Assertable is abstract and should not be constructed directly."
            );
          });
        ...
        { "./util/ensure.js": 23, "./util/oop.js": 24, "./util/shim.js": 25 }
      ],
      3: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function AbsolutePosition(
            dimension,
            value
          ) {
            ...
            switch (dimension) {
              ...
              case Y_DIMENSION:
                ...
                break;
              default:
                ensure.unreachable("Unknown dimension: " + dimension);
            }
        ...
        {
          "../util/ensure.js": 23,
          "../values/position.js": 27,
          "./position_descriptor.js": 11
        }
      ],
      4: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function Center(
            dimension,
            position1,
            position2,
            description
      ...
      5: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function Descriptor() {
              ...
              "Descriptor is abstract and should not be constructed directly."
            );
          });
          Me.extend = oop.extendFn(Me);
          oop.makeAbstract(Me, ["value", "toString"]);
          ...
          Me.prototype.diff = function diff(expected) {
            ...
            try {
              ...
              throw new Error(
                "Can't compare " + this + " to " + expected + ": " + err.message
              );
            }
          };
          ...
          function normalizeType(self, expected) {
            ...
            if (
              expectedType === "object" &&
              (expected instanceof Me || expected instanceof Value)
            )
              return expected;
            ...
            if (expected === undefined) {
              ...
              throw new Error(
                "Can't compare " + self + " to " + explanation + "."
              );
            }
          }
        },
      ...
      6: [
        function(require, module, exports) {
          ...
          function elementRendered(self, rawPosition) {
            ...
            var inDom = element.frame
              .body()
              .toDomElement()
              .contains(element.toDomElement());
      ...
      7: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function ElementRendered(element) {
            ...
            this.width = GenericSize.create(
              this.left,
              this.right,
              "rendered width of " + element
            );
            this.height = GenericSize.create(
              this.top,
              this.bottom,
              "rendered height of " + element
            );

            this.center = Center.x(
              this.left,
              this.right,
              "rendered center of " + element
            );
            this.middle = Center.y(
              this.top,
              this.bottom,
              "rendered middle of " + element
            );
          });
          ...
          Me.prototype.value = function value() {
            if (this.top.value().equals(Position.noY()))
              return RenderState.notRendered();
        ...
        },
        {
          ...
          "../util/ensure.js": 23,
          "../values/position.js": 27,
          "../values/render_state.js": 28,
          "./center.js": 4,
          "./descriptor.js": 5,
          "./element_rendered_edge.js": 8,
          "./generic_size.js": 9
        }
      ],
      8: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function ElementVisibleEdge(
            element,
            position
          ) {
            var QElement = require("../q_element.js"); // break circular dependency
          ...
          Me.prototype.value = function() {
            ...
            if (element.top.value().equals(Position.noY()))
              return notRendered(position);
            if (element.width.value().equals(Size.create(0)))
              return notRendered(position);
            if (element.height.value().equals(Size.create(0)))
              return notRendered(position);
            ...
            if (isClippedOutOfExistence(bounds, edges))
              return notRendered(position);
          ...
          function intersectionWithClip(element, bounds) {
            ...
            for (; element !== null; element = element.parent()) {
              ...
              if (clip === "auto" || !canBeClippedByClipProperty(element))
                continue;
          ...
          function normalizeClipProperty(element, clip) {
            ...
            return {
              ...
              right:
                clipValues[1] === "auto"
                  ...
                  : element.left
                      .value()
                      .plus(Position.x(Number(clipValues[1]))),
              bottom:
                clipValues[2] === "auto"
                  ? element.bottom.value()
            ...
            function parseClipProperty(element, clip) {
              ...
              var matches = clipRegex.exec(clip);
                ...
                matches !== null,
                "Unable to parse clip property: " + clip
              );
            ...
            function parseLength(pxString, clip) {
              ...
              var matches = pxRegex.exec(pxString);
                ...
                matches !== null,
                "Unable to parse '" + pxString + "' in clip property: " + clip
              );
          ...
          function isClippedByAncestorOverflow(element, ancestor) {
            return (
              canBeClippedByOverflowProperty(element) &&
              hasClippingOverflow(ancestor)
            );
          }
          ...
          function intersection(bounds, top, right, bottom, left) {
            ...
            bounds.right =
              bounds.right === null ? right : bounds.right.min(right);
            bounds.bottom =
              bounds.bottom === null ? bottom : bounds.bottom.min(bottom);
          ...
          function isClippedOutOfExistence(bounds, edges) {
            return (
              bounds.top.compare(edges.bottom) >= 0 ||
              (bounds.right !== null &&
                bounds.right.compare(edges.left) <= 0) ||
              (bounds.bottom !== null &&
                bounds.bottom.compare(edges.top) <= 0) ||
      ...
      9: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function GenericSize(
            from,
            to,
            description
          ) {
          ...
          Me.prototype.toString = function toString() {
            ...
            switch (this._edge) {
              case TOP:
                return "top of page";
              case RIGHT:
                return "right side of page";
              case BOTTOM:
                return "bottom of page";
              case LEFT:
                return "left side of page";
      ...
      11: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function PositionDescriptor(dimension) {
              ...
              "PositionDescriptor is abstract and should not be constructed directly."
            );
          });
          Descriptor.extend(Me);
          Me.extend = oop.extendFn(Me);
          ...
          Me.prototype.plus = function plus(amount) {
            if (this._pdbc.dimension === X_DIMENSION)
              return RelativePosition().right(this, amount);
            else return RelativePosition().down(this, amount);
          };

          Me.prototype.minus = function minus(amount) {
            if (this._pdbc.dimension === X_DIMENSION)
              return RelativePosition().left(this, amount);
          ...
          Me.prototype.to = function to(position) {
            ...
            if (typeof position === "number") {
              if (this._pdbc.dimension === X_DIMENSION)
                position = AbsolutePosition().x(position);
            ...
            return GenericSize().create(
              this,
              position,
              "distance from " + this + " to " + position
            );
          };
          ...
          Me.prototype.convert = function convert(arg, type) {
            switch (type) {
              case "number":
                return this._pdbc.dimension === X_DIMENSION
                  ? Position.x(arg)
                  : Position.y(arg);
              case "string":
                if (arg === "none")
      ...
      12: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function RelativePosition(
            dimension,
            direction,
            relativeTo,
            relativeAmount
          ...
          Me.prototype.toString = function toString() {
            ...
            if (this._dimension === X_DIMENSION)
              relation +=
                this._direction === PLUS ? " to right of " : " to left of ";
      ...
      13: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function RelativeSize(
            direction,
            relativeTo,
            amount
          ) {
      ...
      14: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function SizeDescriptor() {
              ...
              "SizeDescriptor is abstract and should not be constructed directly."
            );
          });
          Descriptor.extend(Me);
          Me.extend = oop.extendFn(Me);
          ...
          Me.prototype.convert = function convert(arg, type) {
            switch (type) {
              case "number":
                return Size.create(arg);
              case "string":
                return arg === "none" ? Size.createNone() : undefined;
              default:
                return undefined;
            }
          };
      ...
      15: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function SizeMultiple(
            relativeTo,
            multiple
          ) {
          ...
          Me.prototype.toString = function toString() {
            ...
            switch (multiple) {
              ...
              case 1 / 8:
                ...
                break;
              case 3 / 8:
                desc = "three-eighths of ";
                break;
              case 5 / 8:
                desc = "five-eighths of ";
                break;
              case 7 / 8:
                desc = "seven-eighths of ";
                break;
              default:
          ...
          Me.prototype.value = function() {
            ...
            switch (this._position) {
              case TOP:
                return y;
              case RIGHT:
                return x.plus(Position.x(size.width));
              case BOTTOM:
                return y.plus(Position.y(size.height));
              case LEFT:
                return x;
      ...
      17: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function QElement(
            domElement,
            frame,
            nickname
          ) {
          ...
          Me.prototype.getRawStyle = function(styleName) {
            ...
            if (window.getComputedStyle) {
              ...
              styles = this.frame
                .toDomElement()
                .contentWindow.getComputedStyle(this._domElement);
          ...
          Me.prototype.getRawPosition = function() {
            ...
            return {
              ...
              right: rect.right,
              width:
                rect.width !== undefined ? rect.width : rect.right - rect.left,

              top: rect.top,
              bottom: rect.bottom,
              height:
                rect.height !== undefined ? rect.height : rect.bottom - rect.top
            };
          };
          ...
          Me.prototype.parent = function(nickname) {
            ...
            if (nickname === undefined)
              nickname = "parent of " + this._nickname;
          ...
          Me.prototype.add = function(html, nickname) {
            ...
            if (nickname === undefined)
              nickname = html + " in " + this._nickname;

            var tempElement = document.createElement("div");
            tempElement.innerHTML = shim.String.trim(html);
            ensure.that(
              tempElement.childNodes.length === 1,
              "Expected one element, but got " +
                tempElement.childNodes.length +
                " (" +
                html +
                ")"
            );
        ...
        {
          "../vendor/camelcase-1.0.1-modified.js": 32,
          "./assertable.js": 2,
          "./descriptors/center.js": 4,
          "./descriptors/element_edge.js": 6,
          "./descriptors/element_rendered.js": 7,
          "./descriptors/generic_size.js": 9,
          "./q_frame.js": 19,
          "./util/ensure.js": 23,
          "./util/shim.js": 25
        }
      ...
      18: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function QElementList(
            nodeList,
            frame,
            nickname
          ) {
        ...
        { "./q_element.js": 17, "./q_frame.js": 19, "./util/ensure.js": 23 }
      ],
      19: [
        function(require, module, exports) {
          // Copyright (c) 2014-2017 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
          ...
          function checkUrls(src, stylesheets, callback) {
            ...
            function checkStylesheet(url, callback2) {
              urlExists(url, function(err, stylesheetExists) {
                ...
                if (!stylesheetExists)
                  return callback2(error("stylesheet", url));
            ...
            function error(name, url) {
              return new Error(
                "404 error while loading " + name + " (" + url + ")"
              );
            }
          }
          ...
          function urlExists(url, callback) {
            ...
            http.onreadystatechange = function() {
              // WORKAROUND IE 8: doesn't support .addEventListener() or .onload
              if (http.readyState === STATUS_AVAILABLE) {
                return callback(null, http.status !== 404);
              }
            };
            http.onerror = function() {
              // onerror handler is not tested
              return callback(
                "XMLHttpRequest error while using HTTP HEAD on URL '" +
                  url +
                  "': " +
                  http.statusText
              );
          ...
          function loadStylesheets(self, urls, callback) {
            ...
            function addLinkTag(url, onLinkLoad) {
              ...
              shim.EventTarget.addEventListener(link, "load", function(event) {
                onLinkLoad(null);
              });
          ...
          Me.prototype.getRawScrollPosition = function getRawScrollPosition() {
            ...
            return {
              x: shim.Window.pageXOffset(
                this._domElement.contentWindow,
                this._document
              ),
              y: shim.Window.pageYOffset(
                this._domElement.contentWindow,
                this._document
              )
            };
          ...
          function ensureLoaded(self) {
              ...
              self._loaded,
              "QFrame not loaded: Wait for frame creation callback to execute before using frame"
            );
          }
        ...
        {
          "../vendor/async-1.4.2.js": 31,
          "./q_element.js": 17,
          "./q_element_list.js": 18,
          "./q_page.js": 20,
          "./q_viewport.js": 21,
          "./quixote.js": 22,
          "./util/ensure.js": 23,
      ...
      21: [
        ...
        },
        {
          ...
          "./descriptors/center.js": 4,
          "./descriptors/generic_size.js": 9,
          "./descriptors/viewport_edge.js": 16,
          "./q_frame.js": 19,
          "./util/ensure.js": 23
        }
      ],
      22: [
        function(require, module, exports) {
          ...
          exports.createFrame = function(options, callback) {
            return QFrame.create(document.body, options, function(
              err,
              callbackFrame
            ) {
              if (features === null) {
          ...
          exports.browser.enlargesFrameToPageSize = createDetectionMethod(
            "enlargesFrame"
          );
          exports.browser.enlargesFonts = createDetectionMethod(
            "enlargesFonts"
          );
          exports.browser.misreportsClipAutoProperty = createDetectionMethod(
            "misreportsClipAuto"
          );
          exports.browser.misreportsAutoValuesInClipProperty = createDetectionMethod(
            "misreportsClipValues"
          );
          exports.browser.roundsOffPixelCalculations = createDetectionMethod(
          ...
          function detectBrowserFeatures(callback) {
            ...
            features = {};
            var frame = QFrame.create(
              document.body,
              { width: FRAME_WIDTH, height: FRAME_HEIGHT },
              function(err) {
                if (err) {
                  console.log(
                    "Error while creating Quixote browser feature detection frame: " +
                      err
                  );
                  return callback();
                }
                ...
                try {
                  features.enlargesFrame = detectFrameEnlargement(
                    frame,
                    FRAME_WIDTH
                  );
                  features.misreportsClipAuto = detectReportedClipAuto(frame);
                  features.misreportsClipValues = detectReportedClipPropertyValues(
                    frame
                  );
                  features.roundsOffPixelCalculations = detectRoundsOffPixelCalculations(
                    frame
                  );
                  ...
                  console.log(
                    "Error during Quixote browser feature detection: " + err2
                  );
                }
              }
            );
          ...
          function detectFrameEnlargement(frame, frameWidth) {
            frame.add(
              "<div style='width: " +
                (frameWidth + 200) +
                "px'>force scrolling</div>"
            );
            return !frame
              .viewport()
              .width.value()
              .equals(Size.create(frameWidth));
          }

          function detectFontEnlargement(frame, frameWidth, callback) {
            ensure.that(
              frameWidth >= 1500,
              "Detector frame width must be larger than screen to detect font enlargement"
            );
          ...
          function detectReportedClipPropertyValues(frame) {
            var element = frame.add(
              "<div style='clip: rect(auto, auto, auto, auto);'></div>"
            );
            var clip = element.getRawStyle("clip");
          ...
          function detectRoundsOffPixelCalculations(frame) {
            ...
            if (size === 8) return true;
              ...
              "Failure in roundsOffPixelValues() detection: expected 7.5 or 8, but got " +
                size
            );
          }
        },
        { "./q_frame.js": 19, "./util/ensure.js": 23, "./values/size.js": 29 }
      ],
      23: [
        function(require, module, exports) {
          ...
          exports.that = function(variable, message) {
            ...
            if (variable === false)
              throw new EnsureException(exports.that, message);
            if (variable !== true)
          ...
          exports.signature = function(args, signature) {
            ...
            if (actualArgCount > expectedArgCount) {
              throw new EnsureException(
                exports.signature,
                "Function called with too many arguments: expected " +
                  expectedArgCount +
                  " but got " +
                  actualArgCount
              );
          ...
          function argMatchesAnyPossibleType(arg, type) {
            ...
            function argMatchesType(arg, type) {
              switch (getArgType(arg)) {
                ...
                case "object":
                  return type === Object || arg instanceof type;
                case "undefined":
                  return type === undefined;
                case "null":
                  return type === null;
                case "NaN":
                  return typeof type === "number" && isNaN(type);
          ...
          var EnsureException = (exports.EnsureException = function EnsureException(
        ...
        function(require, module, exports) {
          ...
          exports.extendFn = function extendFn(parentConstructor) {
            return function(childConstructor) {
              childConstructor.prototype = shim.Object.create(
          ...
          exports.makeAbstract = function makeAbstract(constructor, methods) {
            ...
            shim.Array.forEach(methods, function(method) {
              constructor.prototype[method] = function() {
                throw new Error(
                  name + " subclasses must implement " + method + "() method"
                );
              };
            });
            ...
            constructor.prototype.checkAbstractMethods = function checkAbstractMethods() {
              ...
              shim.Array.forEach(methods, function(name) {
                if (self[name] === constructor.prototype[name])
      ...
      26: [
        function(require, module, exports) {
          ...
          Me.prototype.diff = Value.safe(function diff(expected) {
            ...
            var desc = difference;
            if (difference * 100 !== Math.floor(difference * 100))
              desc = "about " + difference.toFixed(2);
            return desc + "px";
          });
      ...
      27: [
        function(require, module, exports) {
          ...
          var Me = (module.exports = function Position(dimension, value) {
            ...
            this._dimension = dimension;
            this._value =
              typeof value === "number" ? Pixels.create(value) : value;
          });
          Value.extend(Me);
          ...
          Me.prototype.plus = Value.safe(function plus(operand) {
            ...
            return new Me(
              this._dimension,
              this._value.plus(operand.toPixels())
            );
          });
          ...
          Me.prototype.minus = Value.safe(function minus(operand) {
            ...
            return new Me(
              this._dimension,
              this._value.minus(operand.toPixels())
            );
          });
          ...
          Me.prototype.midpoint = Value.safe(function midpoint(operand) {
            ...
            return new Me(
              this._dimension,
              this._value.average(operand.toPixels())
            );
          });
          ...
          Me.prototype.min = Value.safe(function min(operand) {
            ...
            return new Me(
              this._dimension,
              Pixels.min(this._value, operand.toPixels())
            );
          });
          ...
          Me.prototype.max = Value.safe(function max(operand) {
            ...
            return new Me(
              this._dimension,
              Pixels.max(this._value, operand.toPixels())
            );
          });
          ...
          Me.prototype.diff = Value.safe(function diff(expected) {
            ...
            if (actualValue.equals(expectedValue)) return "";
            else if (isNone(expected) && !isNone(this))
              return "rendered when not expected";
            ...
            if (this._dimension === X_DIMENSION)
              ...
              direction =
                comparison < 0 ? "higher than expected" : "lower than expected";
      ...
      29: [
        function(require, module, exports) {
          ...
          Me.prototype.diff = Value.safe(function diff(expected) {
            ...
            if (actualValue.equals(expectedValue)) return "";
            if (isNone(expected) && !isNone(this))
              return "rendered when not expected";
            if (!isNone(expected) && isNone(this)) return "not rendered";

            var desc =
              actualValue.compare(expectedValue) > 0
        ...
        { "../util/ensure.js": 23, "./pixels.js": 26, "./value.js": 30 }
      ],
      30: [
        function(require, module, exports) {
          // Copyright (c) 2014 Titanium I.T. LLC. All rights reserved. For license, see "README" or "LICENSE" file.
          ...
          Me.extend = oop.extendFn(Me);
          oop.makeAbstract(Me, ["compatibility", "diff", "toString"]);
          ...
          function ensureCompatibility(self, compatible, args) {
            ...
            for (var i = 0; i < args.length; i++) {
              // args is not an Array, can't use forEach
              arg = args[i];
          ...
          function checkOneArg(self, compatible, arg) {
            ...
            function throwError(type) {
              throw new Error(
                oop.instanceName(self) + " isn't compatible with " + type
              );
            }
          }
        },
